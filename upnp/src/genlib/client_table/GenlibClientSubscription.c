...
GenlibClientSubscription *GenlibClientSubscription_dup(
...
int GenlibClientSubscription_set_RenewEventId(
...
int GenlibClientSubscription_set_SID(
...
size_t GenlibClientSubscription_get_SID_Length(
        const GenlibClientSubscription *p)
{
...
int GenlibClientSubscription_strcpy_SID(
        GenlibClientSubscription *p, const char *s)
{
        return UpnpString_set_String(p->m_SID, s);
}

int GenlibClientSubscription_strncpy_SID(
...
int GenlibClientSubscription_set_ActualSID(
        GenlibClientSubscription *p, const UpnpString *s)
{
        const char *q = UpnpString_get_String(s);
...
int GenlibClientSubscription_strcpy_ActualSID(
        GenlibClientSubscription *p, const char *s)
{
        return UpnpString_set_String(p->m_ActualSID, s);
}

int GenlibClientSubscription_strncpy_ActualSID(
        GenlibClientSubscription *p, const char *s, size_t n)
{
...
int GenlibClientSubscription_set_EventURL(
        GenlibClientSubscription *p, const UpnpString *s)
{
        const char *q = UpnpString_get_String(s);
...
const char *GenlibClientSubscription_get_EventURL_cstr(
        const GenlibClientSubscription *p)
{
        return UpnpString_get_String(GenlibClientSubscription_get_EventURL(p));
}

int GenlibClientSubscription_strcpy_EventURL(
        GenlibClientSubscription *p, const char *s)
{
        return UpnpString_set_String(p->m_EventURL, s);
}

int GenlibClientSubscription_strncpy_EventURL(
        GenlibClientSubscription *p, const char *s, size_t n)
{
...
GenlibClientSubscription *GenlibClientSubscription_get_Next(
        const GenlibClientSubscription *p)
{
        return p->m_Next;
}

int GenlibClientSubscription_set_Next(
