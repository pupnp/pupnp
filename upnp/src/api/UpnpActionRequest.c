...
int UpnpActionRequest_assign(UpnpActionRequest *p, const UpnpActionRequest *q)
{
	...
	if (p != q) {
		...
		ok = ok && UpnpActionRequest_set_HttpHeadersList(
...
int UpnpActionRequest_strncpy_ErrStr(
...
int UpnpActionRequest_strncpy_ActionName(
	UpnpActionRequest *p, const char *s, size_t n)
{
...
int UpnpActionRequest_strncpy_DevUDN(
	UpnpActionRequest *p, const char *s, size_t n)
{
...
int UpnpActionRequest_strncpy_ServiceID(
	UpnpActionRequest *p, const char *s, size_t n)
{
