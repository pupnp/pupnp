...
EXPORT_SPEC int UpnpFileInfo_set_ContentType(UpnpFileInfo *p, const DOMString s); 
...
EXPORT_SPEC const UpnpListHead *UpnpFileInfo_get_ExtraHeadersList(const UpnpFileInfo *p);
/*! UpnpFileInfo_set_ExtraHeadersList */
EXPORT_SPEC int UpnpFileInfo_set_ExtraHeadersList(UpnpFileInfo *p, const UpnpListHead *q);
/*! UpnpFileInfo_add_to_list_ExtraHeadersList */
EXPORT_SPEC void UpnpFileInfo_add_to_list_ExtraHeadersList(UpnpFileInfo *p, UpnpListHead *head);

/*! UpnpFileInfo_get_CtrlPtIPAddr */
EXPORT_SPEC const struct sockaddr_storage *UpnpFileInfo_get_CtrlPtIPAddr(const UpnpFileInfo *p);
/*! UpnpFileInfo_get_CtrlPtIPAddr */
EXPORT_SPEC int UpnpFileInfo_set_CtrlPtIPAddr(UpnpFileInfo *p, const struct sockaddr_storage *buf); 
/*! UpnpFileInfo_get_CtrlPtIPAddr */
...
EXPORT_SPEC int UpnpFileInfo_strncpy_Os(UpnpFileInfo *p, const char *s, size_t n); 
