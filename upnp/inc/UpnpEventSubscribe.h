...
/*! Copy Constructor */
EXPORT_SPEC UpnpEventSubscribe *UpnpEventSubscribe_dup(
	const UpnpEventSubscribe *p);
/*! Assignment operator */
EXPORT_SPEC int UpnpEventSubscribe_assign(
...
EXPORT_SPEC const UpnpString *UpnpEventSubscribe_get_SID(
	const UpnpEventSubscribe *p);
/*! UpnpEventSubscribe_set_SID */
EXPORT_SPEC int UpnpEventSubscribe_set_SID(
	UpnpEventSubscribe *p, const UpnpString *s);
/*! UpnpEventSubscribe_get_SID_Length */
EXPORT_SPEC size_t UpnpEventSubscribe_get_SID_Length(
	const UpnpEventSubscribe *p);
/*! UpnpEventSubscribe_get_SID_cstr */
EXPORT_SPEC const char *UpnpEventSubscribe_get_SID_cstr(
	const UpnpEventSubscribe *p);
/*! UpnpEventSubscribe_strcpy_SID */
EXPORT_SPEC int UpnpEventSubscribe_strcpy_SID(
	UpnpEventSubscribe *p, const char *s);
/*! UpnpEventSubscribe_strncpy_SID */
EXPORT_SPEC int UpnpEventSubscribe_strncpy_SID(
...
EXPORT_SPEC const UpnpString *UpnpEventSubscribe_get_PublisherUrl(
	const UpnpEventSubscribe *p);
/*! UpnpEventSubscribe_set_PublisherUrl */
EXPORT_SPEC int UpnpEventSubscribe_set_PublisherUrl(
	UpnpEventSubscribe *p, const UpnpString *s);
/*! UpnpEventSubscribe_get_PublisherUrl_Length */
EXPORT_SPEC size_t UpnpEventSubscribe_get_PublisherUrl_Length(
	const UpnpEventSubscribe *p);
/*! UpnpEventSubscribe_get_PublisherUrl_cstr */
EXPORT_SPEC const char *UpnpEventSubscribe_get_PublisherUrl_cstr(
	const UpnpEventSubscribe *p);
/*! UpnpEventSubscribe_strcpy_PublisherUrl */
EXPORT_SPEC int UpnpEventSubscribe_strcpy_PublisherUrl(
	UpnpEventSubscribe *p, const char *s);
/*! UpnpEventSubscribe_strncpy_PublisherUrl */
EXPORT_SPEC int UpnpEventSubscribe_strncpy_PublisherUrl(
	UpnpEventSubscribe *p, const char *s, size_t n);
