...
/*! Copy Constructor */
EXPORT_SPEC UpnpStateVarRequest *UpnpStateVarRequest_dup(
	const UpnpStateVarRequest *p);
/*! Assignment operator */
EXPORT_SPEC int UpnpStateVarRequest_assign(
...
EXPORT_SPEC const UpnpString *UpnpStateVarRequest_get_ErrStr(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_set_ErrStr */
EXPORT_SPEC int UpnpStateVarRequest_set_ErrStr(
	UpnpStateVarRequest *p, const UpnpString *s);
/*! UpnpStateVarRequest_get_ErrStr_Length */
EXPORT_SPEC size_t UpnpStateVarRequest_get_ErrStr_Length(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_get_ErrStr_cstr */
EXPORT_SPEC const char *UpnpStateVarRequest_get_ErrStr_cstr(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_strcpy_ErrStr */
EXPORT_SPEC int UpnpStateVarRequest_strcpy_ErrStr(
	UpnpStateVarRequest *p, const char *s);
/*! UpnpStateVarRequest_strncpy_ErrStr */
EXPORT_SPEC int UpnpStateVarRequest_strncpy_ErrStr(
...
EXPORT_SPEC const UpnpString *UpnpStateVarRequest_get_DevUDN(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_set_DevUDN */
EXPORT_SPEC int UpnpStateVarRequest_set_DevUDN(
	UpnpStateVarRequest *p, const UpnpString *s);
/*! UpnpStateVarRequest_get_DevUDN_Length */
EXPORT_SPEC size_t UpnpStateVarRequest_get_DevUDN_Length(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_get_DevUDN_cstr */
EXPORT_SPEC const char *UpnpStateVarRequest_get_DevUDN_cstr(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_strcpy_DevUDN */
EXPORT_SPEC int UpnpStateVarRequest_strcpy_DevUDN(
	UpnpStateVarRequest *p, const char *s);
/*! UpnpStateVarRequest_strncpy_DevUDN */
EXPORT_SPEC int UpnpStateVarRequest_strncpy_DevUDN(
	UpnpStateVarRequest *p, const char *s, size_t n);
...
EXPORT_SPEC const UpnpString *UpnpStateVarRequest_get_ServiceID(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_set_ServiceID */
EXPORT_SPEC int UpnpStateVarRequest_set_ServiceID(
	UpnpStateVarRequest *p, const UpnpString *s);
/*! UpnpStateVarRequest_get_ServiceID_Length */
EXPORT_SPEC size_t UpnpStateVarRequest_get_ServiceID_Length(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_get_ServiceID_cstr */
EXPORT_SPEC const char *UpnpStateVarRequest_get_ServiceID_cstr(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_strcpy_ServiceID */
EXPORT_SPEC int UpnpStateVarRequest_strcpy_ServiceID(
	UpnpStateVarRequest *p, const char *s);
/*! UpnpStateVarRequest_strncpy_ServiceID */
EXPORT_SPEC int UpnpStateVarRequest_strncpy_ServiceID(
	UpnpStateVarRequest *p, const char *s, size_t n);
...
EXPORT_SPEC const UpnpString *UpnpStateVarRequest_get_StateVarName(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_set_StateVarName */
EXPORT_SPEC int UpnpStateVarRequest_set_StateVarName(
	UpnpStateVarRequest *p, const UpnpString *s);
/*! UpnpStateVarRequest_get_StateVarName_Length */
EXPORT_SPEC size_t UpnpStateVarRequest_get_StateVarName_Length(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_get_StateVarName_cstr */
EXPORT_SPEC const char *UpnpStateVarRequest_get_StateVarName_cstr(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_strcpy_StateVarName */
EXPORT_SPEC int UpnpStateVarRequest_strcpy_StateVarName(
	UpnpStateVarRequest *p, const char *s);
/*! UpnpStateVarRequest_strncpy_StateVarName */
EXPORT_SPEC int UpnpStateVarRequest_strncpy_StateVarName(
	UpnpStateVarRequest *p, const char *s, size_t n);
...
EXPORT_SPEC const struct sockaddr_storage *UpnpStateVarRequest_get_CtrlPtIPAddr(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_getnc_CtrlPtIPAddr */
EXPORT_SPEC struct sockaddr_storage *UpnpStateVarRequest_getnc_CtrlPtIPAddr(
	UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_get_CtrlPtIPAddr */
EXPORT_SPEC int UpnpStateVarRequest_set_CtrlPtIPAddr(
...
EXPORT_SPEC const DOMString UpnpStateVarRequest_get_CurrentVal(
	const UpnpStateVarRequest *p);
/*! UpnpStateVarRequest_set_CurrentVal */
EXPORT_SPEC int UpnpStateVarRequest_set_CurrentVal(
	UpnpStateVarRequest *p, const DOMString s);
/*! UpnpStateVarRequest_get_CurrentVal_cstr */
EXPORT_SPEC const char *UpnpStateVarRequest_get_CurrentVal_cstr(
	const UpnpStateVarRequest *p);
