...
EXPORT_SPEC const UpnpString *UpnpDiscovery_get_DeviceID(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_set_DeviceID */
EXPORT_SPEC int UpnpDiscovery_set_DeviceID(
...
EXPORT_SPEC int UpnpDiscovery_strncpy_DeviceID(
...
EXPORT_SPEC const UpnpString *UpnpDiscovery_get_DeviceType(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_set_DeviceType */
EXPORT_SPEC int UpnpDiscovery_set_DeviceType(
	UpnpDiscovery *p, const UpnpString *s);
...
EXPORT_SPEC const char *UpnpDiscovery_get_DeviceType_cstr(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_strcpy_DeviceType */
EXPORT_SPEC int UpnpDiscovery_strcpy_DeviceType(
	UpnpDiscovery *p, const char *s);
/*! UpnpDiscovery_strncpy_DeviceType */
EXPORT_SPEC int UpnpDiscovery_strncpy_DeviceType(
	UpnpDiscovery *p, const char *s, size_t n);
...
EXPORT_SPEC const UpnpString *UpnpDiscovery_get_ServiceType(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_set_ServiceType */
EXPORT_SPEC int UpnpDiscovery_set_ServiceType(
	UpnpDiscovery *p, const UpnpString *s);
...
EXPORT_SPEC const char *UpnpDiscovery_get_ServiceType_cstr(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_strcpy_ServiceType */
EXPORT_SPEC int UpnpDiscovery_strcpy_ServiceType(
	UpnpDiscovery *p, const char *s);
/*! UpnpDiscovery_strncpy_ServiceType */
EXPORT_SPEC int UpnpDiscovery_strncpy_ServiceType(
	UpnpDiscovery *p, const char *s, size_t n);
...
EXPORT_SPEC const UpnpString *UpnpDiscovery_get_ServiceVer(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_set_ServiceVer */
EXPORT_SPEC int UpnpDiscovery_set_ServiceVer(
	UpnpDiscovery *p, const UpnpString *s);
...
EXPORT_SPEC const char *UpnpDiscovery_get_ServiceVer_cstr(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_strcpy_ServiceVer */
EXPORT_SPEC int UpnpDiscovery_strcpy_ServiceVer(
	UpnpDiscovery *p, const char *s);
/*! UpnpDiscovery_strncpy_ServiceVer */
EXPORT_SPEC int UpnpDiscovery_strncpy_ServiceVer(
	UpnpDiscovery *p, const char *s, size_t n);
/*! UpnpDiscovery_clear_ServiceVer */
EXPORT_SPEC void UpnpDiscovery_clear_ServiceVer(UpnpDiscovery *p);

/*! UpnpDiscovery_get_Location */
EXPORT_SPEC const UpnpString *UpnpDiscovery_get_Location(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_set_Location */
EXPORT_SPEC int UpnpDiscovery_set_Location(
	UpnpDiscovery *p, const UpnpString *s);
...
EXPORT_SPEC int UpnpDiscovery_strncpy_Location(
	UpnpDiscovery *p, const char *s, size_t n);
...
EXPORT_SPEC int UpnpDiscovery_strncpy_Os(
	UpnpDiscovery *p, const char *s, size_t n);
...
EXPORT_SPEC int UpnpDiscovery_strncpy_Date(
	UpnpDiscovery *p, const char *s, size_t n);
...
EXPORT_SPEC int UpnpDiscovery_strncpy_Ext(
	UpnpDiscovery *p, const char *s, size_t n);
/*! UpnpDiscovery_clear_Ext */
EXPORT_SPEC void UpnpDiscovery_clear_Ext(UpnpDiscovery *p);

/*! UpnpDiscovery_get_DestAddr */
EXPORT_SPEC const struct sockaddr_storage *UpnpDiscovery_get_DestAddr(
	const UpnpDiscovery *p);
/*! UpnpDiscovery_getnc_DestAddr */
EXPORT_SPEC struct sockaddr_storage *UpnpDiscovery_getnc_DestAddr(
	UpnpDiscovery *p);
/*! UpnpDiscovery_get_DestAddr */
EXPORT_SPEC int UpnpDiscovery_set_DestAddr(
