		...
		foreach (line ${configure})
			...
			elseif (line MATCHES "[. \t]*AC_DEFINE_UNQUOTED *\\(([^,]*), *([^,]*), *([^\\)]*)")
				...
				if (FIRSTCHAR STREQUAL "\"")
					if (SAVED_MATCH STREQUAL "UPNP_VERSION_STRING")
						file (APPEND ${CMAKE_CURRENT_BINARY_DIR}/autoconfig.h.cm "#cmakedefine ${CMAKE_MATCH_1} \$\{UPNP_SOVERSION\}\n\n")
					else()
					...
					if (${CMAKE_MATCH_1} MATCHES VERSION AND NOT ${${CMAKE_MATCH_1}})
						...
						if (SAVED_MATCH STREQUAL "UPNP_VERSION_MAJOR")
							file (APPEND ${CMAKE_CURRENT_BINARY_DIR}/autoconfig.h.cm "#cmakedefine ${SAVED_MATCH} \$\{UPNP_SOMAJOR\}\n\n")
						else()
