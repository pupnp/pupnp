...
With Doxygen installed, build the docs from the repository root.

Autotools:

```sh
make html   # generates HTML under docs/doxygen/html/index.html
make pdf    # also produces docs/doxygen/latex/libupnp-reference.pdf
```
