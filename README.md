...
| branch         | status                                                                                              |
| -------------- | --------------------------------------------------------------------------------------------------- |
| main  (22.1.x) | ![main](https://github.com/pupnp/pupnp/actions/workflows/ccpp.yml/badge.svg?branch=main)            |
...
The Portable SDK for UPnP&trade; Devices is an SDK for development of UPnP device and control point applications. It consists of the core UPnP protocols along with a UPnP-specific eXtensible Markup Language (XML) parser supporting the Document Object Model (DOM) Level 2 API and an optional, integrated mini web server for serving UPnP related documents. It provides developers with an API and open source code for building control points, devices, and bridges that are compliant with Version 1.0 of the [Universal Plug and Play Device Architecture Specification](https://openconnectivity.org/developer/specifications/upnp-resources/upnp/) and supports several operating systems like Linux, *BSD, Solaris and others.

## 2. General Information

UPnP&trade; is an architecture that enables discovery, event notification, and control of devices on a network, independent of operating system, programming language, or physical network connection.&nbsp; UPnP&trade; is based on common Internet standards and specifications such as TCP/IP, HTTP, and XML. For detailed information about UPnP&trade;, including the UPnP&trade; Device Architecture Specification, please visit the [Open Connectivity Foundation web site](https://openconnectivity.org/), which took over the UPnP&trade; Forum's work in 2016.

In 2000, Intel created the first version of the Linux SDK for UPnP&trade; Devices and subsequently released it to the open source community to foster growth of UPnP&trade;.
...
The documentation resides inside the source code itself and is generated by [Doxygen](https://www.doxygen.nl). Documentation for each function resides in a comment section immediately preceding the function.

With Doxygen installed, build the docs from your build directory:

```sh
cmake --build . --target docs   # generates HTML under docs/doxygen/html/index.html
```

Note: the `UPnP_Programming_Guide.pdf` included in the `docs/` directory is from version 1.2 and is outdated.
...
| 22.1.1         | 2026-09-22 | [Portable UPnP SDK][Portable UPnP SDK]   |
| 22.1.0         | 2026-09-10 | [Portable UPnP SDK][Portable UPnP SDK]   |
| 22.0.6         | 2026-08-12 | [Portable UPnP SDK][Portable UPnP SDK]   |
| 22.0.5         | 2026-08-12 | [Portable UPnP SDK][Portable UPnP SDK]   |
| 22.0.4         | 2026-07-15 | [Portable UPnP SDK][Portable UPnP SDK]   |
...
| 1.14.27        | 2026-02-08 | [Portable UPnP SDK][Portable UPnP SDK]   |
| 1.14.26        | 2026-02-06 | [Portable UPnP SDK][Portable UPnP SDK]   |
| 1.14.25        | 2025-09-18 | [Portable UPnP SDK][Portable UPnP SDK]   |
...
- UPNP_ENABLE_TESTING: This option activates the unit tests.

- UPNP_ENABLE_TESTING_INTEGRATION: This option activates the integration tests (find_package/add_subdirectory consumption checks).
